...
We have 12 sampling models defined by different combinations of 3 precinct categories and 4 crime types. We Setting prior distribution on regression coefficient $\beta$ and over-dispersion factor $\alpha$ as follows: 
...
![Estimated rates of different ethnicities for stopped for different categories of crime based on coefficients from hiearchical regression](images/interaction1.png)
