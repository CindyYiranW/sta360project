...
As we adopt hiearchical Negative Binomial distribution as our sampling model, there are 12 sampling models defined by different combinations of 3 precinct categories and 4 crime types. Setting prior distribution  
\[
\begin{eqnarray}
